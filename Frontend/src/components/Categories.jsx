  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setCategories((res.categories || []).slice(0, 4));
      } catch (err) {
  ...
  const fallbackCategories = [
    {
      _id: "1",
      name: "Fresh Chicken",
      description: "Farm-fresh, hygienically processed daily",
      image: "https://images.unsplash.com/photo-1587593810167-a84920ea0781?w=900&q=80",
    },
    {
      _id: "2",
      name: "Masalas",
      description: "Authentic blends with rich aroma",
        ...
        {displayCategories.map((cat) => (
          ...
          >
            ...
            <span className="absolute top-5 right-5 bg-gradient-fire text-white
              ...
              {cat.productCount ? `${cat.productCount} Products` : "Shop Now"}
            </span>
