...
.pk-head h1 { font-family: 'Fraunces', serif; font-size: 1.4rem; font-weight: 800; color: #2B1B14; margin: 0; }
.pk-head-icon {
...
.pk-empty { background: white; border: 1px solid rgba(100,31,40,0.08); border-radius: 14px; padding: 44px 24px; text-align: center; }
...
.pk-empty h2 { color: #2B1B14; font-size: 1.2rem; font-weight: 700; margin: 0 0 6px 0; }
.pk-empty p { color: #8B7355; margin: 0; font-size: 0.85rem; }
.pk-stack { display: flex; flex-direction: column; gap: 12px; }
.pk-card {
  background: white; border: 1px solid rgba(100,31,40,0.08); border-radius: 14px;
...
.pk-card:hover { border-color: rgba(100,31,40,0.2); box-shadow: 0 4px 12px rgba(100,31,40,0.06); }
.pk-row { display: flex; justify-content: space-between; align-items: center; gap: 14px; flex-wrap: wrap; }
.pk-id { font-size: 1rem; font-weight: 700; color: #2B1B14; margin: 0 0 8px 0; }
.pk-meta { display: flex; align-items: center; gap: 7px; color: #8B7355; font-size: 0.83rem; margin-bottom: 5px; }
.pk-total { display: flex; align-items: center; gap: 4px; font-size: 1.05rem; font-weight: 800; color: #641F28; margin-top: 8px; }
.pk-btn {
  ...
  color: white; background: linear-gradient(135deg, #641F28, #641F28); box-shadow: 0 4px 14px rgba(100,31,40,0.28);
}
.pk-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(100,31,40,0.36); }
`;
