  ...
  <section className="mm-hero relative min-h-screen flex items-center overflow-hidden px-6 pt-28 pb-20 lg:px-16">
    ...
    <style>{`
      ...
      .mm-glow {
        ...
        background: radial-gradient(circle, rgba(201,162,39,0.16) 0%, rgba(13,120,120,0.08) 45%, transparent 72%);
      ...
      .mm-btn-primary {
        ...
        box-shadow: 0 8px 30px rgba(13,120,120,0.45), 0 0 0 1px rgba(201,162,39,0.15);
        transition: all .35s cubic-bezier(.16,.84,.32,1);
      }
      .mm-btn-primary:hover {
        box-shadow: 0 16px 46px rgba(180,35,44,0.55), 0 0 0 1px rgba(201,162,39,0.45);
      ...
      .mm-seal-core {
        ...
        box-shadow:
          ...
          -6px -6px 16px rgba(201,162,39,0.07),
      ...
      .mm-seal-core-sm {
        ...
        box-shadow:
          ...
          -3px -3px 8px rgba(201,162,39,0.06),
          inset 0 0 0 1px rgba(201,162,39,0.3);
      }
