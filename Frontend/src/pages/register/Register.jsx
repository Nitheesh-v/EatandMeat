...
.reg-visual-glow-1 { width: 380px; height: 380px; top: -10%; left: -10%; background: radial-gradient(circle, rgba(180,35,44,0.3), transparent 70%); animation: regGlow1 20s ease-in-out infinite; }
.reg-visual-glow-2 { width: 340px; height: 340px; bottom: -10%; right: -10%; background: radial-gradient(circle, rgba(201,162,39,0.2), transparent 70%); animation: regGlow2 24s ease-in-out infinite; }
...
.reg-ember {
  ...
  background: radial-gradient(circle at 35% 30%, #ffc98a, #B4232C 55%, transparent 75%);
...
.reg-role-select:focus { outline: none; border-color: #B4232C; box-shadow: 0 0 0 3px rgba(180,35,44,0.15); }
...
.reg-input:focus { outline: none; border-color: #B4232C; box-shadow: 0 0 0 3px rgba(180,35,44,0.15); }
...
.reg-toggle-pw:hover { color: #B4232C; }

.reg-terms-row { display: flex; align-items: flex-start; gap: 10px; margin-top: 18px; }
.reg-terms-row input[type="checkbox"] { accent-color: #B4232C; width: 17px; height: 17px; margin-top: 2px; cursor: pointer; }
.reg-terms-label { color: rgba(255,255,255,0.5); font-size: 0.85rem; line-height: 1.4; }
.reg-terms-link { color: #C9A227; font-weight: 600; text-decoration: none; }
.reg-terms-link:hover { text-decoration: underline; }

.reg-submit-btn {
  width: 100%; background: linear-gradient(135deg, #B4232C 0%, #D4354A 100%);
  border: none; border-radius: 14px; color: white; font-weight: 700; font-size: 1rem; padding: 15px;
  cursor: pointer; box-shadow: 0 6px 20px rgba(180,35,44,0.35); transition: all 0.3s ease;
  display: flex; align-items: center; justify-content: center; gap: 10px; margin-top: 22px;
}
.reg-submit-btn:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(180,35,44,0.5); }
...
.reg-signin-link { color: #C9A227; font-weight: 700; text-decoration: none; margin-left: 6px; }
        ...
        <div className="reg-visual">
          ...
          <div className="relative z-10 flex items-center gap-2 mt-20">
            <div
              ...
              style={{ background: "linear-gradient(135deg, #B4232C, #D4354A)", boxShadow: "0 4px 15px rgba(180,35,44,0.5)" }}
            >
