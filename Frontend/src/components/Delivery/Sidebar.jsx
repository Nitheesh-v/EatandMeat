  ...
  return (
    <aside
      ...
      style={{
        ...
        boxShadow: "2px 0 20px rgba(147,51,234,0.05)",
      }}
    >
      {/* Top accent line */}
      <div style={{ height: 3, background: "linear-gradient(90deg, #9333ea, #ec4899, #f472b6)" }} />
      ...
      >
        ...
        <h2 className="text-xl font-extrabold tracking-tight">
          <span style={{ color: "#1e293b" }}>Eat</span>
          <span style={{ color: "#9333ea" }}>And</span>
          <span style={{ color: "#ec4899" }}>Meat</span>
        </h2>
      </div>

      {/* Partner info */}
      <div className="p-4" style={{ borderBottom: "1px solid rgba(147,51,234,0.06)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold uppercase tracking-wider mt-0.5" style={{ color: "#9333ea" }}>
              Delivery Partner
            </p>
          </div>
        </div>
          ...
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              background: isActive
                ...
                : "transparent",
              boxShadow: isActive ? "0 4px 15px rgba(147,51,234,0.25)" : "none",
            })}
            onMouseEnter={(e) => {
