...
.adp-search-input::placeholder { color: #CBD5E1; }
.adp-search-input:focus { outline: none; border-color: #2563EB; box-shadow: 0 0 0 3px rgba(212,175,55,0.12); }
.adp-search-icon { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #CBD5E1; }
.adp-grid {
  display: grid;
...
.adp-card-contact span { display: flex; align-items: center; gap: 4px; font-size: 0.75rem; color: #94A3B8; }
...
.adp-stat-label { font-size: 0.65rem; font-weight: 600; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.5px; }
...
.adp-action-btn:hover { background: rgba(212,175,55,0.12); color: #2563EB; border-color: rgba(212,175,55,0.3); }
.adp-empty { text-align: center; padding: 60px 20px; color: #94A3B8; }
.adp-loading { display: flex; align-items: center; justify-content: center; min-height: 200px; color: #64748B; }
`;
