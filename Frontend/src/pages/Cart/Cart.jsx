      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: "radial-gradient(circle, rgba(180,35,44,0.12) 0%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
        ...
        <div className="relative z-10 max-w-lg mx-auto text-center px-4">
          ...
          >
            <ShoppingCart
              size={56}
              style={{ color: "rgba(180,35,44,0.8)" }}
            />
          </div>
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: "-5%",
          right: "-5%",
          background: "radial-gradient(circle, rgba(180,35,44,0.1) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          >
            <span className="font-bold" style={{ color: "#C9A227" }}>{totalItems}</span>{" "}
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-5">
            {cartItems.map((item, index) => (
              <div
                ...
                onMouseEnter={(e) => {
                  if (removingId !== item._id) {
                    e.currentTarget.style.borderColor = "rgba(180,35,44,0.2)";
                    e.currentTarget.style.transform = "translateY(-2px)";
                    e.currentTarget.style.boxShadow = "0 8px 30px rgba(180,35,44,0.08)";
                  }
                }}
                onMouseLeave={(e) => {
                  if (removingId !== item._id) {
              ...
              >
                ...
                <div
                  className="h-1"
                  style={{ background: "linear-gradient(90deg, #B4232C, #D4354A, #C9A227)" }}
                />
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          height: 28,
                          background: "linear-gradient(135deg, #B4232C, #D4354A)",
                          boxShadow: "0 2px 8px rgba(180,35,44,0.5)",
                        }}
                      >
                        {item.quantity}
                      </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p
                            ...
                            style={{ color: "rgba(255,255,255,0.4)" }}
                          >
                            <Tag size={12} style={{ color: "#C9A227" }} />
                            {item.weight}
                          </p>
                        </div>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "1px solid rgba(180,35,44,0.15)",
                          }}
                          title="Remove item"
                          onMouseEnter={(e) => {
                            e.currentTarget.style.background = "rgba(180,35,44,0.2)";
                            e.currentTarget.style.borderColor = "rgba(180,35,44,0.4)";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.background = "rgba(180,35,44,0.08)";
                            e.currentTarget.style.borderColor = "rgba(180,35,44,0.15)";
                          }}
                        >
                          <Trash2 size={15} style={{ color: "#B4232C" }} />
                        </button>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-4 flex-wrap gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            onMouseEnter={(e) => {
                              e.currentTarget.style.background = "rgba(180,35,44,0.15)";
                              e.currentTarget.style.borderColor = "rgba(180,35,44,0.3)";
                            }}
                            onMouseLeave={(e) => {
          ...
          <div className="lg:col-span-1">
            ...
            >
              {/* Header */}
              <div className="h-1" style={{ background: "linear-gradient(90deg, #C9A227, #f6e3a1)" }} />
              <div className="p-6">
                ...
                <Link
                  ...
                  style={{ color: "rgba(255,255,255,0.4)" }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.color = "#B4232C";
                  }}
                  onMouseLeave={(e) => {
